...
$(() => {
    ...
    //         inputTime.attr("value", dateStr);
    //         buttonText.text(dateStr);
    //     },
    // });
    ...
    $(".estate-calender-box").each((index, calender) => {
        ...
        let calenderBox = flatpickr($(calender) ,{
            ...
            onChange: function(selectedDates, dateStr, instance) {
                ...
                $("#control_calender").slideDown(400)
                $("#page-content.calender .calender-layout").removeClass("w-100")
                $("#page-content.calender .calender-layout").removeClass("pb-0")
            },
        });
    ...
    calendersBoxs.forEach( instance => {
        ...
        instance.config.onDayCreate = [function (dObj, dStr, fp, dayElem) {
            ...
            // Add your custom price => backend data
            // dayElem.setAttribute("data-calender-price", "30" + " " + "رس")
...
/* Calender  */
if(document.querySelector(".calender-layout")) {

    $(".container-lg").addClass("calender-container");


    $(".close-aside").on("click", () => {
        $("#control_calender").slideUp(400)
        $("#page-content.calender .calender-layout").addClass("w-100")
        $("#page-content.calender .calender-layout").addClass("pb-0")
    })
}
...
if(el) {
    ...
    el.addEventListener("input", () => {
        ...
        widthMachine.textContent = el.value;
...
// slider container 
const sliderContainerboxs = document.querySelectorAll(".box-container");
...
if (sliderContainerboxs) {
    ...
    sliderContainerboxs.forEach((container) => {
        ...
        // slider arrows 
        const nextButton = document.querySelector(".box-container .next");
        const prevButton = document.querySelector(".box-container .prev");
